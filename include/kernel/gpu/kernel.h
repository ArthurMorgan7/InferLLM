...
// 宏函数的使用，这相当于在预处理阶段生成了大量基本重复的代码（天才）
...
namespace gpu {
    ...
    PartialImplementKernel(MatmulWithHeadStrideQBroadCastKFloat,llm_matmul_compute_with_head_strideq_broadcastk_float);
    PartialImplementKernel(HeadBatchedMatmulBroadCastVFloat, llm_head_batched_matmul_broadcastv_float);
